...
function Adatvedelem() {
  return (
    <div className="page-container adatvedelem-page">
      ...
      <p>A személyes adatokat az alábbi célokra használjuk fel:</p>
      <ul>
        <li>rendelések fogadása, feldolgozása és teljesítése</li>
        <li>házhozszállítás megszervezése</li>
        <li>fiókregisztráció és bejelentkezés biztosítása</li>
        <li>ügyfélszolgálati kapcsolattartás</li>
        <li>panaszkezelés és hibajavítás</li>
        <li>számlázási és könyvelési kötelezettségek teljesítése</li>
        <li>jogszabályi kötelezettségek teljesítése</li>
        <li>weboldal biztonságának fenntartása</li>
        <li>statisztikai és szolgáltatásfejlesztési célok</li>
      </ul>
      ...
      <p>
        A személyes adatokat kizárólag a szolgáltatás teljesítéséhez szükséges
        partnerek részére továbbíthatjuk, például:
      </p>
      <ul>
        <li>futárszolgálat vagy saját kiszállító partner</li>
        <li>számlázó rendszer</li>
        <li>tárhelyszolgáltató</li>
        <li>fizetési szolgáltató</li>
      </ul>
      <p>
        Az adattovábbítás minden esetben a vonatkozó adatvédelmi szabályok
      ...
      <p>
        A PizzArena minden elvárható technikai és szervezési intézkedést
        megtesz a személyes adatok védelme érdekében. Törekszünk arra, hogy az
        adatok védve legyenek:
      </p>
      <ul>
        <li>illetéktelen hozzáférés ellen</li>
        <li>elvesztés vagy sérülés ellen</li>
        <li>jogosulatlan módosítás ellen</li>
        <li>jogosulatlan továbbítás ellen</li>
      </ul>
      ...
      <ul>
        ...
        <li>adatainak törlését kérni</li>
        <li>az adatkezelés korlátozását kérni</li>
        <li>tiltakozni az adatkezelés ellen</li>
        <li>adathordozhatósághoz való jogával élni</li>
        <li>panaszt tenni a hatóságnál</li>
      </ul>

      <h2>10. Panaszkezelés</h2>
      <p>
        Amennyiben úgy érzed, hogy személyes adataid kezelése során jogsérelem
        ért, elsőként kérjük, vedd fel velünk a kapcsolatot. Törekszünk minden
        panasz gyors és korrekt rendezésére.
      </p>
